...
export const CLI_COMMANDS: CliCommandMetadata[] = [
  {
    ...
    usage: "brna snapshot [--format md|markdown|json|yaml] [--diff [--target <selector>]] [--active-layer] [--image --image-to <path>] [--metro <url>] [--timeout <ms>] [--device <id>]",
    options: [
      ...
      { name: "--target", description: "Focus --diff output to one selector's region." },
